...
export interface Evaluator<BehaviorArgument, BehaviorResult, BehaviorMetrics> {
  ...
  validate(argument: BehaviorArgument): Promise<{}>;
  ...
  /// - Cost
  /// - Success probability
  estimate(argument: BehaviorArgument): Promise<BehaviorMetrics>;
  ...
  expand(argument: BehaviorArgument): Promise<BehaviorArgument>;
} 